...
class EmailConnection::Gmail::Delivery
  ...
  rescue EmailConnection::Errors::AuthenticationError
    raise
  rescue Google::Apis::AuthorizationError => error
    connection.mark_errored!(error)
    raise EmailConnection::Errors::AuthenticationError, error.message
  rescue Google::Apis::RateLimitError => error
    raise EmailConnection::Errors::TemporaryDeliveryError, error.message
  rescue Google::Apis::RequestTimeOutError,
    Google::Apis::ServerError,
    Google::Apis::TransmissionError => error
    raise EmailConnection::Errors::AmbiguousDeliveryError, error.message
  ...
  private
    ...
    def classify_client_error!(error)
      ...
      raise EmailConnection::Errors::PermanentDeliveryError, error.message
    end
